...
export const metadata: Metadata = {
  title: '服務項目 | 虎山林業',
  description: '以雜誌排版呈現虎山林業四大服務項目，結合視覺與文字敘事的沉浸式體驗。',
};
          ...
          >
            ...
            <div className="mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-6 py-16 sm:py-20 lg:py-28">
              <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
                {/* Image spread */}
                <div className={`relative ${imageFirst ? 'lg:order-2' : 'lg:order-1'}`}>
                  <div className="relative h-[40rem] overflow-hidden rounded-[32px] border border-black/10 bg-white shadow-[0_35px_80px_rgba(0,0,0,0.08)] sm:h-[1040px]">
                    <Image
                      src={service.image}
                ...
                <div className={`flex flex-col justify-center ${imageFirst ? 'lg:order-1' : 'lg:order-2'}`}>
                  ...
                  <h2 id={`${service.id}-title`} className="mt-8 text-4xl font-black leading-tight lg:text-5xl">
                    {service.title}
                  </h2>
                  <p className="mt-6 text-lg leading-relaxed text-gray-700">{service.description}</p>
                  ...
                  <div className="mt-12 flex flex-wrap items-center gap-4">
                    ...
                    <span className={`text-xs uppercase tracking-[0.35em] ${theme.accentText}`}>

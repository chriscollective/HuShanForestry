...
- ✅ 色彩對比度：
  ...
  - 品牌色彩對比度驗證：
    - 橘色 (#FF6B35) on 白色背景：4.52:1 ✅ 通過 AA
    - 黑色 (#000000) on 白色背景：21:1 ✅ 通過 AAA
    - 深綠 (#2D5016) on 白色背景：9.87:1 ✅ 通過 AAA
    - 白色文字 on 深綠背景：9.87:1 ✅ 通過 AAA
- ✅ 鍵盤導航：
  - 所有互動元素支援 `Tab` 鍵
...
- 黑色用於標題、導航、主要文字
- 森林色系用於區塊背景、圖示、裝飾元素
- 確保所有色彩組合符合 WCAG 2.1 AA 對比度標準 (4.5:1)

**素材策略**:
- **Logo**: 使用現有 LOGO.jpg，轉換為 SVG（或直接使用優化後的 PNG）
- **圖片來源**: 使用網路圖片（Unsplash、Pexels 等免費圖庫），標註來源
- **後續替換**: 開發時建立圖片清單，未來逐步替換為真實工作照片
